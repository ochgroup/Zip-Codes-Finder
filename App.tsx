      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/search" className="text-gray-600 dark:text-gray-300 hover:text-[#8B5CF6] dark:hover:text-[#8B5CF6] font-medium transition">Search</Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white dark:bg-gray-900 border-b border-purple-100 dark:border-gray-800 shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
             ...
             <Link to="/search" onClick={() => setIsOpen(false)} className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-200 hover:text-[#8B5CF6] hover:bg-purple-50 dark:hover:bg-gray-800">Search</Link>
